...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='General deep learning framework for Molecular Spectra')
    ...
    # if you want try other datasets, please download datasets and write corresponding data loaders
    ...
    # ----ACT
    # ------------Learnable Spectral Processing
    parser.add_argument('--norm_lr', type=float, default=0.01, help='lr 4 label normalizer')
    ...
    filedir_dict = {"apple_leaf": "appleLeaf",
                    "mango_dmc": "mangoDMC", "melamine": "Melamine",
                    "strawberry_puree": "strawberryPuree", "tablet": "tablet"}
